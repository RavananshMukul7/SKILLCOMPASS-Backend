const swaggerDocument = {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "API documentation for the SkillCompass AI Career Intelligence Platform.",
    },
    servers: [
        {
    ...
    paths: {
        ...
        "/api/auth/register": {
            ...
            post: {
                ...
                description: "Creates a new SkillCompass account and establishes a session.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/auth/login": {
            ...
            post: {
                tags: ["Authentication"],
                summary: "Log in",
                description: "Authenticates a user and establishes a session using an HTTP-only session cookie.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/auth/sessions/{sessionId}": {
            delete: {
                ...
                description: "Revokes one active session belonging to the authenticated user.",
                security: [
                    {
                        sessionCookie: [],
                    },
        ...
        "/api/github/connect": {
            get: {
                ...
                description: "Starts the GitHub OAuth authorization flow for the authenticated SkillCompass user.",
                security: [
                    {
                        sessionCookie: [],
                    },
        ...
        "/api/github/repositories/sync": {
            post: {
                ...
                description: "Fetches the authenticated user's GitHub repositories and synchronizes them with SkillCompass.",
                security: [
                    {
                        sessionCookie: [],
                    },
        ...
        "/api/analysis/repositories/{repositoryId}/analyze": {
            post: {
                ...
                description: "Starts an analysis run for a repository owned by the authenticated user.",
                security: [
                    {
                        sessionCookie: [],
                    },
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                type: "object",
                                description: "Request body validated by analyzeRepositorySchema.",
        ...
        "/api/matching/jobs/{jobId}/match": {
            post: {
                ...
                description: "Calculates how well the authenticated user's skills match a job using a completed analysis run.",
                security: [
                    {
                        sessionCookie: [],
                    },
        ...
        "/api/jobs/recommended": {
            get: {
                ...
                description: "Returns jobs recommended for the authenticated user based on a completed analysis run.",
                security: [
                    {
                        sessionCookie: [],
                    },
        ...
        "/api/jobs/recommended/generate": {
            post: {
                ...
                description: "Calculates and stores job matches for all jobs with skills using a completed analysis run.",
                security: [
                    {
                        sessionCookie: [],
                    },
