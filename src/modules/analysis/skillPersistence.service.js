...
export const persistExtractedSkills = async ({ userId, analysisRunId, skills, technologyEvidenceByName, }) => {
    ...
    for (const extractedSkill of skills) {
        ...
        for (const evidence of extractedSkill.evidence) {
            const technologyEvidence = technologyEvidenceByName.get(evidence.technologyName
                .trim()
                .toLowerCase());
            ...
            await prisma.skillEvidence.upsert({
                where: {
                    userSkillId_technologyEvidenceId: {
                        ...
                        technologyEvidenceId: technologyEvidence.id,
                    },
                },
                update: {
