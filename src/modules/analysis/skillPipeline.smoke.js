import { detectTechnologiesFromSource, } from "./technologyDetection.service.js";
...
for (const file of files) {
    const technologies = detectTechnologiesFromSource(file);
...
console.log(JSON.stringify(technologyInputs, null, 2));
const extractedSkills = extractSkillsFromTechnologies(technologyInputs);
console.log("\nEXTRACTED SKILLS:");
